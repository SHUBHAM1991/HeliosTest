...
function s_doPlugins(s) {
	...
	if(document.referrer.indexOf('weeklyad.staples.com') > -1){
	   s.eVar3='Weekly Ad';
	   s.eVar37=s.eVar3;
	}
	...
	if(s_thisPage.indexOf("weeklyad") > -1 || s_thisPage.indexOf("shoplocal") > -1){
		...
		s.prop29=s.eVar44=s.eVar3="Weekly Ad";		
	}	
	else{
...
function s_prodAffinity(product,findMethod,referralType,recRule){
	...
	s.eVar3=findMethod;
	s.eVar16=product;
	s.eVar17=findMethod + ':' + referralType;
	s.eVar45=recRule;
 ...
 * recommendation type
 */
function s_findMethod(findMethod,recommendType){
	//s_findMethod('Weekly Circular')
	if(recommendType){
		s.linkTrackVars='eVar3,eVar17';
		s.eVar17=findMethod + ':' + recommendType;
	}
	else{
...
function s_atcOverlayRecom(findMethod,clickType,products){
	...
	if(true){
        	s.linkTrackVars='prop3,prop4,prop5,prop6,eVar3,products';
                s.linkTrackEvents='none'; 
                s.eVar3=findMethod; 
                s.prop3='Checkout'; 
