 ...
 *  </p>
 */
public class LeadCustomerMapper implements RowMapper<CustProfileVO> , StaplesDashBoardRowMapper{
	...
	public List<Object> mapRow(List<Map<String, Object>> resultMap) {
		...
		if (resultMap != null && !resultMap.isEmpty()) {
			for (Map<String, Object> rs : resultMap) {
				...
				customerVO
						.setLeadCompanyName(rs
								.get("COMPANY_NAME") == null ? MapperConstants.BLANK_STRING
								: rs.get("COMPANY_NAME")
										.toString());
				customerVO
						.setLeadCustomerNumber(rs
								.get("CUSTOMER_NUMBER") == null ? MapperConstants.BLANK_STRING
								: rs.get(
										"CUSTOMER_NUMBER")
										.toString());
				customerVO
						.setLeadCustomerEmail(rs.get("EMAIL") == null ? MapperConstants.BLANK_STRING
								: rs.get("EMAIL")
										.toString());
				customerVO
						.setLeadCustomerFirstName(rs
								.get("FIRST_NAME") == null ? MapperConstants.BLANK_STRING
								: rs.get("FIRST_NAME")
										.toString());
				customerVO
				.setLeadCustomerLastName(rs
						.get("LAST_NAME") == null ? MapperConstants.BLANK_STRING
						: rs.get("LAST_NAME")
								.toString());
				
				customerVO
						.setLeadCustomerPhone(rs.get("PHONE_NUMBER") == null ? MapperConstants.BLANK_STRING
								: rs.get("PHONE_NUMBER")
										.toString());
				customerVO
				.setLeadContractType(rs.get("CONTRACT_TYPE") == null ? MapperConstants.BLANK_STRING
						: rs.get("CONTRACT_TYPE")
								.toString());
