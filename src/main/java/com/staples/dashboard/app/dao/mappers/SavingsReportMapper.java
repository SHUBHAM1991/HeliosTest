...
public class SavingsReportMapper implements RowMapper<SavingsDetailDTO> , StaplesDashBoardRowMapper {
		...
		List<Object> objects = null;
		    if (resultMap != null && !resultMap.isEmpty()) {
		      ...
		      for (Map<String, Object> rs : resultMap) {
		        ...
		        savingsVo.setProjectedRebate(rs.get(MapperConstants.SAVINGS_REPORT_MAPPER_PROJECTED_REBATE) == null ? MapperConstants.BLANK_STRING
						: rs.get(MapperConstants.SAVINGS_REPORT_MAPPER_PROJECTED_REBATE).toString());
		        ...
		        savingsVo.setOrderNumber(rs.get(MapperConstants.SAVINGS_REPORT_MAPPER_ORDER_NUMBER) == null ? MapperConstants.BLANK_STRING
		         ...
		         savingsVo.setOrderDate(rs.get(MapperConstants.SAVINGS_REPORT_MAPPER_ORDERDATE) == null ? MapperConstants.BLANK_STRING
						: rs.get(MapperConstants.SAVINGS_REPORT_MAPPER_ORDERDATE).toString());
		        savingsVo.setUnitPrice(rs.get(MapperConstants.SAVINGS_REPORT_MAPPER_UNITPRICE) == null ? MapperConstants.BLANK_STRING
						: rs.get(MapperConstants.SAVINGS_REPORT_MAPPER_UNITPRICE).toString());
		        savingsVo.setChildNumber(rs.get(MapperConstants.SAVINGS_REPORT_MAPPER_CHILDNUMBER) == null ? MapperConstants.BLANK_STRING
						: rs.get(MapperConstants.SAVINGS_REPORT_MAPPER_CHILDNUMBER).toString());
