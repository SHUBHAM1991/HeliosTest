...
var tempslfIds=new Array();
 $(document).ready(function(){
	 ...
	 $(window).resize(function() { 
		 if(undefined != pieChartDataSet && '' !=pieChartDataSet && $(window).width()>=1024){
 ...
 getLatestFiscalDateOrder(); 
	...
	$('#scrollTop').click(function(){ 
	 ...
	 if(''!=$('#fromCdmSeeAll').val() && 'fromCdmSeeAll'==$('#fromCdmSeeAll').val()){
		...
		$("#menuItemId1").css("background-color","#fff");
		$("#menuItemId1").css("color","#444");
		$("#menuItemId1").css("border","border: 1px solid #444;");
...
$(function () {
	  ...
	  function populateDataOnLoad(latestDate,users){
		 ...
		 if(latestDate!=null && latestDate!=undefined && yearChange==0){
			 $("#yrId option[value="+latestDate.substring(2,6)+"]").attr("selected",true);
		 }
			 ...
			 var year=$("#yrId").val();
			 $("#monthTitle").html("");
			 $("#monthTitle").html('<span> '+year+' Monthly Spend Analysis <i style="font-size:18px !important;line-height:12px; !important" class="fa fa-angle-double-right"></i></span>');
			 $.ajax({
				 	dataType: "json",
						 ...
						 $('#tableId').html("");
									if(data.objSummaryVO.listYTDSpend !=null && data.objSummaryVO.listYTDSpend !=undefined){
										$.each(data.objSummaryVO.listYTDSpend, function(i, item) {
											mkttrHTML += '<tr class=""><td class="datatablesTd" style="">' + checkUundefined(item.data[0]) + '</td><td class="datatablesTd formatCls">'
													
													+ chkNegAmount(checkUundefined(item.data[1])) + '</td><td class="datatablesTd formatCls" style="">'
													+ chkNegAmount(checkUundefined(item.data[2])) + '</td><td class="datatablesTd formatCls" style="">'
													+ chkNegAmount(checkUundefined(item.data[3])) + '</td><td class="datatablesTd formatCls" style="">'
													+ chkNegAmount(checkUundefined(item.data[4])) + '</td><td class="datatablesTd formatCls" style="">'
													+ chkNegAmount(checkUundefined(item.data[5])) + '</td><td class="datatablesTd formatCls" style="">'
													+ chkNegAmount(checkUundefined(item.data[6])) + '</td><td class="datatablesTd formatCls" style="">'
													+ chkNegAmount(checkUundefined(item.data[7])) + '</td><td class="datatablesTd formatCls" style="">'
													+ chkNegAmount(checkUundefined(item.data[8])) + '</td><td class="datatablesTd formatCls" style="">'
													+ chkNegAmount(checkUundefined(item.data[9])) + '</td><td class="datatablesTd formatCls" style="color:#111 !important;">'
													+ chkNegAmount(checkUundefined(item.data[10])) + '</td></tr>';
										});
										...
										+ chkNegAmount(checkUundefined(data.objSummaryVO.listFooter[0])) + '</td><td class="datatablesTd formatCls" style="color:#111 !important;">'
										+ chkNegAmount(checkUundefined(data.objSummaryVO.listFooter[1])) + '</td><td class="datatablesTd formatCls" style="color:#111 !important;">'
										+ chkNegAmount(checkUundefined(data.objSummaryVO.listFooter[2])) + '</td><td class="datatablesTd formatCls" style="color:#111 !important;">'
										+ chkNegAmount(checkUundefined(data.objSummaryVO.listFooter[3])) + '</td><td class="datatablesTd formatCls" style="color:#111 !important;">'
										+ chkNegAmount(checkUundefined(data.objSummaryVO.listFooter[4])) + '</td><td class="datatablesTd formatCls" style="color:#111 !important;">'
										+ chkNegAmount(checkUundefined(data.objSummaryVO.listFooter[5])) + '</td><td class="datatablesTd formatCls" style="color:#111 !important;">'
										+ chkNegAmount(checkUundefined(data.objSummaryVO.listFooter[6])) + '</td><td class="datatablesTd formatCls" style="color:#111 !important;">'
										+ chkNegAmount(checkUundefined(data.objSummaryVO.listFooter[7])) + '</td><td class="datatablesTd formatCls" style="color:#111 !important;">'
										+ chkNegAmount(checkUundefined(data.objSummaryVO.listFooter[8])) + '</td><td class="datatablesTd formatCls" style="color:#111 !important;">'
										+ chkNegAmount(checkUundefined(data.objSummaryVO.listFooter[9])) + '</td></tr>';
										
									}

									$('#tableId').html(
											('<table class="table" id="dataTables-example1">'.toString())
									...
									table.fnDraw();
									if(undefined != data.listOfCustProfileVO[0] && '' != data.listOfCustProfileVO[0]){
									...
									if(undefined != data.listOfCustProfileVO[0] && data.listOfCustProfileVO[0].iamId != '-' && data.listOfCustProfileVO[0].iamId !=''){
										$("#cnoId").html("");
										$("#logId").html("");
									...
									}else if(undefined != data.listOfCustProfileVO[0]){
									...
									if(undefined != data.listOfCustProfileVO[0] && undefined != data.listOfCustProfileVO[0].contactStatus && (false != data.listOfCustProfileVO[0].contactStatus)){
							        ...
							        $("#contactName").html("Dummy Name");
							        //LTS saving changes
							        if (undefined != data.listOfCustProfileVO[0] && data.listOfCustProfileVO[0].lts != undefined &&
							        ...
							        var address='';
							        var cityStateZip='';
							        if( undefined != data.listOfCustProfileVO[0] && undefined != data.listOfCustProfileVO[0].companyAddr1 && '' != data.listOfCustProfileVO[0].companyAddr1 && (data.listOfCustProfileVO[0].companyAddr1.length > 1)){
							        ...
							        if(undefined != data.listOfCustProfileVO[0] && undefined != data.listOfCustProfileVO[0] && (data.listOfCustProfileVO[0].companyPhone != undefined && data.listOfCustProfileVO[0].companyPhone != '') && (address !='')){
							        	//alert(data.listOfCustProfileVO[0].companyPhone);
							        	address=address+'<span onclick="javascript:logChangeSatusActivity(8088,\''+formatPhone(data.listOfCustProfileVO[0].companyPhone)+': clicked in Customer Profile Grid Main Dashboard\','+custid+')">'+formatPhone(data.listOfCustProfileVO[0].companyPhone)+'</span>';
							        	$("#addrTxt").css("display","block");
							        }else if((address =='') && undefined != data.listOfCustProfileVO[0] && (data.listOfCustProfileVO[0].companyPhone == undefined || data.listOfCustProfileVO[0].companyPhone == '')){
							        	address="No Address or Phone Found";
							        }else if(address=='' && undefined != data.listOfCustProfileVO[0] && (data.listOfCustProfileVO[0].companyPhone != undefined && data.listOfCustProfileVO[0].companyPhone != '')){
							        	address="P. "+'<span onclick="javascript:logChangeSatusActivity(8088,\''+formatPhone(data.listOfCustProfileVO[0].companyPhone)+': clicked in the Customer Profile Grid Main Dashboard\','+custid+')">'+formatPhone(data.listOfCustProfileVO[0].companyPhone)+'</span>';
							        }else if((address !='') && undefined != data.listOfCustProfileVO[0] && (data.listOfCustProfileVO[0].companyPhone == undefined || data.listOfCustProfileVO[0].companyPhone == '')){
								    ...
								    $.each(data.listOfCustProfileVO, function(i, item) {
								    	...
								    	if(item.repCd == 'DD' && undefined != data.listOfCustProfileVO &&  null != data.listOfCustProfileVO && data.listOfCustProfileVO.length == 2){
								    		managerHtml=managerHtml+'<div style="height:auto" class=""><span id="actMgrName" class="letterSpace" style="font-family: Helvetica;font-size: 14px;font-weight:bold;color: #333;" class="large" >Account Consultant: </span><span id="mgrName" style="font-family:Helvetica !important;font-size:13px;color:#555;font-weight:bold;word-break:break-all;" class="letterSpace">'+item.agentName+'  </span></div>';
								    		$("#loggedInUserName").html(item.agentName);
								    	}
								    	else if(item.repCd == 'DD'){
								    		managerHtml=managerHtml+'<div style="height:auto" class=""><span id="actMgrName" class="letterSpace" style="font-family: Helvetica;font-size: 14px;font-weight:bold;color: #333;" class="large" >Account Manager: </span><span id="mgrName" style="font-family:Helvetica !important;font-size:13px;color:#555;font-weight:bold;word-break:break-all;" class="letterSpace">'+item.agentName+'  </span></div>';
								    		$("#loggedInUserName").html(item.agentName);
								    	}
								    
								    	else if (item.repCd == 'IAC'){
								    		managerHtml=managerHtml+'<div style="height:auto" class=""><span class="letterSpace" style="font-family: Helvetica;font-size: 14px;font-weight:bold;color: #333;" class="large">Inside Account Consultant: </span><span id="mgrNameIAC" style="font-family:Helvetica !important;font-size:13px;color:#555;font-weight:bold;word-break:break-all;" class="letterSpace">'+item.agentName+'  </span></div>';
								    		$("#loggedInUserName").html(item.agentName);
								    	}
								    							    	
								    	managerHtml=managerHtml+'<div style="height:auto" class=""><span class="letterSpace" style="font-family: Helvetica;font-size: 14px;font-weight:bold;color: #333;" class="large">Email: </span> <span style="font-family:Helvetica !important;font-size:13px;color:#555;font-weight:bold;word-break:break-all;" id="mgrEmailId" class="letterSpace">'+item.agentEmailId+'</span></div>'
								    	managerHtml=managerHtml+'<div style="height:auto" class=""><span class="letterSpace" style="font-family: Helvetica;font-size: 14px;font-weight:bold;color: #333;" class="large">Phone Number: </span><span style="font-family:Helvetica !important;font-size:13px;color:#555;font-weight:bold;word-break:break-all;" id="mgrPhoneNum" class="letterSpace" onclick="javascript:logChangeSatusActivity(8091,\''+item.agentPhoneNum+': clicked in the Account Manager Grid Main Dashboard\','+custid+')">'+item.agentPhoneNum+'</span></div><span style="display:none;" id="repVal">'+item.repCd+'</span></div>'
								    ...
								    if(undefined != data.listOfCustProfileVO &&  null != data.listOfCustProfileVO && data.listOfCustProfileVO.length == 2){
								    	...
								    	$("#catContent").attr("style","height:445px !important");
								    }
									...
									$.each(data.ytdInfoVOList, function(i, item) {
										if(i==0)
										$("#year"+i).html(item.year+' Year To Date Net Sales<b>:</b>');
										else
										$("#year"+i).html(item.year+' Net Sales<b>:</b>');	
								    ...
								    latestFiscalYear=latestDate.substring(2,6);
								    }
    ...
    function populateCategoryChart(data){
    	...
    	$("#catTitle").html("");
    	var yr=$("#yrId").val();
    	$("#catTitle").html('<span class="letterSpace">'+yr+' Yearly Spend Per Category <i style="font-size:18px !important;line-height:12px; !important" class="fa fa-angle-double-right"></i></span>');
		...
		var piedata = [];
		 ...
		 if(undefined !=keyArr && '' !=keyArr){
		  piedata=getLableValueMap(keyArr,valArr,valPercentArr);
  ...
  function getLableValueMap(keyArr,valArr,valPercentArr){
	  ...
	  var labels = keyArr;
		...
		return labels.map(function(label){
		   ...
		   count++;
			return { y: values[count] ,seriesText:""+label+"  "+(valuesPercent[count].toFixed(2))+"%" ,legendText:"  - "+label+"  "+(valuesPercent[count].toFixed(2))+"%" , indexLable: false , color:colorsArr[count]}
		});
  }
								...
								if(undefined !=isFromReturned && isFromReturned =='YY'){
									...
									$("#yearSel option[value="+mn+""+yn+"]").attr("selected","selected");
									 $('#datepickerTEXT').val(monthNameArr[mn-1]+" / "+yn);
							          ...
							          $('#da  tepickerTEXT').css("font-family","Hevletica")
		...
		beforeShow : function(input, inst) { 
            ...
            if ((datestr = $(this).val()).length > 0) {
				...
				onChangeMonthYear : function(year, month,inst ) {
					...
					is_dec=is_dec;
					if((undefined != val) && ('selected'==val) && (month==12)){ 
						allselected="Y";
					//e.stopPropagation();
					}
		 ...
		 $.ajax({
				...
				success : function(data, textStatus, jqXHR) {
					...
					if(data != undefined && data !=null && data !=''){
						...
						toggleWirNotAvailable(data.valueAttributionScore);
			...
			"show"      : true           
					...
					var mkttrHTML = "";
					 ...
					 var name='';
								...
								$('#shipToTableId').html(
										'<table class="table table-striped table-bordered table-hover" id="dataTables-exampleShipTo"  ><thead><tr>'
										       ...
										       +'<th>Orders <br/>(CFY)</th>'
												...
												+ '</tr>'
												+ '</thead><tbody>' + mkttrHTML
												+ '</tbody></table><div style="line-height:2.5;"><span style="font-weight: bold;">* </span><span style="font-family: helvetica;">YTD Growth compares CFY Spend to LFY Spend for the exact same time period.</span></div>');
								$("#dataTables-exampleShipTo_processing").css("display","none");
								var shiptoTable=$('#dataTables-exampleShipTo').dataTable({
									// responsive: true
									"lengthMenu": [[5, 15, 25, -1], [5, 15,25, "All"]],
									//"scrollX": true,
								    //searching:false	,
								...
								/*var filteredData = shiptoTable.column( 0 ).data().filter( function ( value, index ) {
							    	alert(value);
							        return value =='SUNN' ? true : false;
							    } );*/
...
function openCustDetailsFromOtherSource(cNum,contactName,contactDate,contactStatus){
	$("#contactName").val(contactName);
	$("#contactDate").val(contactDate);
	$("#contactStatus").val(contactStatus);
	opencustDetails(cNum);
}
...
function populateMonthChartData(firstYearData,secondYearDatadata,thirdYearData,yearsArr){
	...
	var yr=$("#yrId").val();
	$("#mnthTitle").html('<span>'+yr+' Yearly Spend Per Month <i style="font-size:18px !important;line-height:12px; !important" class="fa fa-angle-double-right"></i></span>');
	...
	var chart = AmCharts.makeChart("chartdiv", {
	    ...
	    "graphs": [{
	        ...
	        "balloonText": "Year: "+yearsArr[1]+", [[category]]: $[[value]]",
	        "bullet": "round",
	        "title": yearsArr[1],
	        "lineColor": "red",
	        "type": "line",
	        ...
	        "balloonText": "Year: "+yearsArr[2]+ ", [[category]]: $[[value]]",
	        "bullet": "round",
	        "title": yearsArr[2],
	        "valueField": "year3",
	        "type": "line",
	...
	var formData={};
		 $.ajax({
				...
				if	(undefined !=data && null !=data && '' != data){
					...
					var not_found_html='<div id="chartContainerPie" style="padding-top: 5%;font-weight: 700;font-family: Helvetica;font-size: 20px;color: darkgrey;text-align: center;">NO SALES FOUND FOR THIS YEAR</div>';
					//$('#cpContent').html(not_found_html);
					$('#amContent').html(not_found_html);
					$('#ytContent').html(not_found_html).css('height','100px');;
					$('#catContent').html(not_found_html).css({'height':'430px',"padding-top":"40%"});
					$('#saContent').html(not_found_html).css({'height':'430px',"padding-top":"40%"});
					$('#mnthContent').html(not_found_html);
					$('#mtaContent').html(not_found_html);
					populateNotificationData();
		 ...
		 $.ajax({
				...
				if	(data !=null && data != undefined){
					...
					htmlData=htmlData +' <table id="gitBuilds" class="table table-bordered">'
                           ...
                           +' <td>'
                           +'   <a href="javascript:void();" data-placement="left" data-toggle="tooltip" title="Use for same day or emergency needs" style="text-decoration:none;color:#0066c0;">Buy Online, Pick Up<br>In Store</a></td>';
					      if(data.bopisFlag !=''){
					...
					$("#saContent").html(htmlData);
					 ...
					 if(data.shoppingListFlag !='' && data.shoppingListFlag =='N'){
                        ...
                        +'<tr style=" background-color: #fff;">'
                        +'    <td>'
                        +'    <a href="javascript:void();" data-placement="left" data-toggle="" title="Use for same day or emergency needs" style="text-decoration:none;color:#0066c0;">BOPiS</a></td>'
...
function openReturn(monthYr,Cat,fromRet){
	...
	$("#cusId").css("display","block");
	  $("#superContent").css("display","block");
	  $("#showHideId1").prop('class','fa fa-times');
	  logUserActivity(2018, 'user has viewed order details through SBA online return');
...
function openOrderDetailsShopping(isFromReturned){
	logUserActivity(2026, 'user has viewed order details through SBA Shopping Lists');
	var Amount = new Array();
	...
	if('' !=data && undefined !=data.mktgResources && null !=data.mktgResources && ''!=data.mktgResources){
   	...
   	$("input[id^='param']").each(function () {
		if (undefined != this.id && '' != this.id
			...
			$("#" + (this.id)).attr("style","width:"+ ((this.value.length + 1) * 8.2)	+ 'px !important; '+
...
function toggleWirNotAvailable(subSegment) {

	if((subSegment != null && subSegment !=undefined) &&
	   (subSegment == 'Defector' || subSegment == 'Lapsing' || subSegment == 'Nova' || subSegment == 'Supernova')) {
			$("#menuItemIdWIR").html("Workplace Insights Review");
			$("#wirAnchor").attr("href", "javascript:openPerfDashboard();");
		} else {			
			$("#menuItemIdWIR").html("Workplace Insights Review is n/a. Applicable to Mature accounts only.");
			$("#wirAnchor").removeAttr("href");
		}
...
function populateCustomerProfile() {
	...
	$.ajax({
		...
		success : function(data, textStatus, jqXHR) {
			...
			if(undefined != data.listOfCustProfileVO[0]){
			$("#custNum").html('<a style="pointer-events:none;cursor: default;font-family:Helvetica !important;font-size:13px;color:#555;font-weight:bold">'+data.listOfCustProfileVO[0].custNum+'</a>');
			$("#division").val(data.listOfCustProfileVO[0].division);
		    $("#custType").html(data.listOfCustProfileVO[0].custType);
			}
			if(undefined != data.listOfCustProfileVO && undefined != data.listOfCustProfileVO[0] && data.listOfCustProfileVO[0].iamId != '-' && data.listOfCustProfileVO[0].iamId !=''){
				$("#cnoId").html("");
				$("#logId").html("");
				var sfdcBaseUrl=$("#sfdcAppBaseUrl").val();
				var compNameUrl=sfdcBaseUrl+'/'+data.listOfCustProfileVO[0].iamId;
			...
			}else if(undefined != data.listOfCustProfileVO && undefined != data.listOfCustProfileVO[0]){
				$("#compName").html(data.listOfCustProfileVO[0].companyName);
				$("#ulIamIdSec").css("display","none");
				$("#cnoId").html("");
				$("#logId").html("");
			...
			if(undefined != data.listOfCustProfileVO && undefined != data.listOfCustProfileVO[0] && undefined != data.listOfCustProfileVO[0].contactStatus && (false != data.listOfCustProfileVO[0].contactStatus)){
				$("#contactName").val(data.listOfCustProfileVO[0].loggedInUserName);
				$("#contactDate").val(data.listOfCustProfileVO[0].checkedInDate);
				$("#contactStatus").val(data.listOfCustProfileVO[0].contactStatus);
				$("#contactStatusInfo").css("display","block");
	        ...
	        if (undefined != data.listOfCustProfileVO && undefined != data.listOfCustProfileVO[0] && data.listOfCustProfileVO[0].lts != undefined &&
	        		data.listOfCustProfileVO[0].lts != null &&
	        		data.listOfCustProfileVO[0].lts != '') {
	        	$("#ltsInfoColumn").show();
	        	$("#cpContent").css("height","125px");
	        ...
	        var address='';
	        var cityStateZip='';
	        if(undefined != data.listOfCustProfileVO && undefined != data.listOfCustProfileVO[0].companyAddr1 && '' != data.listOfCustProfileVO[0].companyAddr1 && (data.listOfCustProfileVO[0].companyAddr1.length > 1)){
	          	address=" "+data.listOfCustProfileVO[0].companyAddr1+" "+data.listOfCustProfileVO[0].companyAddr2;
	          	if(address!=' ' && address !='  ')
	          	address=address+"</br>";
	          	if(data.listOfCustProfileVO[0].companyCity !=''){
	        ...
	        if(undefined != data.listOfCustProfileVO && undefined != data.listOfCustProfileVO[0] && (data.listOfCustProfileVO[0].companyPhone != undefined && data.listOfCustProfileVO[0].companyPhone != '') && (address !='')){
	        	address=address+'<span onclick="javascript:logChangeSatusActivity(8088,\''+formatPhone(data.listOfCustProfileVO[0].companyPhone)+': clicked in Customer Profile Grid Main Dashboard\','+custid+')">'+formatPhone(data.listOfCustProfileVO[0].companyPhone)+'</span>';
	        	$("#addrTxt").css("display","block");
	        }else if((address =='') && undefined != data.listOfCustProfileVO && undefined != data.listOfCustProfileVO[0] && (data.listOfCustProfileVO[0].companyPhone == undefined || data.listOfCustProfileVO[0].companyPhone == '')){
	        	address="No Address or Phone Found";
	        }else if(address=='' && undefined != data.listOfCustProfileVO && undefined != data.listOfCustProfileVO[0] && (data.listOfCustProfileVO[0].companyPhone != undefined && data.listOfCustProfileVO[0].companyPhone != '')){
	        	address="P. "+'<span onclick="javascript:logChangeSatusActivity(8088,\''+formatPhone(data.listOfCustProfileVO[0].companyPhone)+': clicked in Customer Profile Grid Main Dashboard\','+custid+')">'+formatPhone(data.listOfCustProfileVO[0].companyPhone)+'</span>';
	        }else if((address !='') && undefined != data.listOfCustProfileVO && undefined != data.listOfCustProfileVO[0] && (data.listOfCustProfileVO[0].companyPhone == undefined || data.listOfCustProfileVO[0].companyPhone == '')){
	        	address=address+"Phone Number Not Found";
	        	$("#addrTxt").css("display","block");
	        }
