...
function populateCustomerProfile() {
	...
	$.ajax({
		...
		success : function(data, textStatus, jqXHR) {
			...
			$("#custConNum").html(" "+'<span  onclick="javascript:logChangeSatusActivity(8089,\''+formatPhoneLead(data.listOfCustProfileVO[0].phoneNum)+': clicked in the Leads Recommendation\','+custid+')">'+formatPhoneLead(data.listOfCustProfileVO[0].phoneNum))+'</span>';
