	     ...
	     <div class="row" id="reorderPane">
		    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			 <div class="offer offer-radius offer-primary">
			  <div style="float:left;"><a href="javascript:void()" class="btn twitterprimary btn-block" role="button">Reorder Pane</a></div>
	     ...
	     <div class="row" id="babPane">
		    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			 <div class="offer offer-radius offer-danger">
			  <!-- <div style="float:left;"><a href="javascript:void()" class="btn twitterdanger btn-block" role="button">Bought Also Bought</a></div> -->
			  <!-- <div style="width: 50%;float:left;">
			  <span style="width: 70%;"><a href="javascript:void()" class="btn twitterdanger btn-block" role="button" style="float: left;width:auto;">Bought Also Bought</a>
				   <label class="col-md-3 control-label" style="font-size: 16px;width: auto;color:#d9534f;">Order Contact</label><select class="form-control" id="orderConId" style="border-color: #d9534f;width: auto !important; color: #d9534f !important;margin-top:1px;">
					<option>--SELECT--</option>
							...
							<div class="col-sm-7" style="float: left; padding-left: 0px;">
								<span class=""> <span class="col-sm-5"
									style="padding-right: 0px; padding-left: 0px;"> <a
										href="javascript:void()" class="btn twitterdanger btn-block"
										role="button"
										style="padding-left: 0px; float: left; /* width:auto; */ padding-right: 0px;">
											Bought Also Bought </a>
								</span> <span class="col-sm-7" style=""> <label
										class="col-sm-6 col-md-3 control-label"
										style="padding-right: 10px; padding-left: 0px; font-size: 16px; width: auto; color: #d9534f;">
											Order Contact </label> <span class="col-sm-5"
										style="padding-left: 0px; padding-right: 0px;"> <select
											class="form-control input-sm" id="orderConId"
											style="padding-right: 0px !important; border-color: #d9534f; width: 130%; color: #d9534f !important; margin-top: 1px; padding-left: 0px;">
										</select>
									</span>
								</span>
				...
				<!-- <div id ='updateDateValueBAB' style="float:right;" ><span  class="" role="button" style="padding: 5px 5px;line-height: 1.5;cursor:default;font-size: 12px;color: #d9534f;font-weight: bold;"></span></div> -->
				<div id="updateDateValueBAB" style="font-family: Helvetica; float:right; font-size: 10px; color: #d9534f; letter-spacing: .5px;padding-top:11px;"><span ></span></div>
				<!-- <div id ='updateDateLabelBAB' style="float:right;"><span class="" role="button" style="padding: 5px 5px;line-height: 1.5;cursor:default;font-size: 12px;color: #d9534f;font-weight: bold;">Refreshed: </span></div> -->
				<div id="updateDateLabelBAB" style="font-family: Helvetica; float:right; font-size: 10px; color: #d9534f; letter-spacing: .5px;padding-top:11px;"><span style="padding-right:3px;">Refreshed: </span></div>
...
$("#showHideIdShipTo").click(function(){ 
	...
	$('#printRecommendationsBtn').click(function () {
		...
		logUserActivity(3002, 'Print Recommendations Page');
	...
	logUserActivity(3001, 'View Recommendations');
