...
<input class="form-control"  name="subPlayParams" id="subPlayParams" type="hidden" value="${requestScope['subPlayParams']}" />
		...
		<div  class="page-content-wrapper" style="background-color:#1d2939;">
		 ...
		 <!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
			...
			<!-- END QUICK SIDEBAR -->
				...
				<div class="portlet box black" id="cpId" style="border: 1px solid #ababab !important;background-color: #fff;">
	...
	<div class="row">
				...
				<div class="row">
					<div class="col-lg-12">
					<div class="portlet box black" style="border: 1px solid #ababab !important;background-color: #fff;border-color: #fff;" id="storeId">
							<div class="portlet-title" style="border-bottom: 1px solid #aaa;background-color: #fff;">
								<div class="caption" style="color: #4d4d4d;font-family:Helvetica !important;">
									<span class="letterSpace" style="font-size: 16px;font-weight: 600;color: #555;">STORES NEAR BY <i style="font-size:18px !important;line-height:12px; !important" class="fa fa-angle-double-right"></i></span>  
								</div>
							</div>
...
$("#growthId").click(function(){
	...
	$('#printStoreLocBtn').click(function () {
		...
		logUserActivityDotCom(7002, 'Print SAM.COM Stores Near By Page');
	...
	logUserActivityDotCom(7044, 'View Stores near by of SAM.COM Customer');
