    ...
    background-color: #555;
		...
		<div class="page-sidebar-wrapper" id="menuContainer" style="">
			...
			<div id="heliosSideBar" class="page-sidebar navbar-collapse collapse msg_container_base" style="background-color:#1d2939;width:100%;margin:0px;">
				...
				<!-- END SIDEBAR MENU -->
				<!-- Notification Start -->
				<ul id="ulPlaySec" class="page-sidebar-menu page-sidebar-menu-hover-submenu " data-keep-expanded="true" data-auto-scroll="true" data-slide-speed="200" style="padding-top:25px;display:none;">
				<!-- <div class="col-md-12" style="padding-left:0px;padding-right:0px;/* border-right:1px solid rgb(62,62,62) */">
					<div class="portlet box green" style="border:1px solid #1d2939;background-color: #1d2939;" id="playSection">
							<div id="playdivId" class="" style="height:38px !important;padding-left:0px;padding-right:0px;background-color: #1d2939;"> -->
								...
								<div class="caption" style="display:none;color: #fff;font-weight:700;font-size:16px;padding-bottom:7px;padding-top:5px;" id="notiId">
									...
									<a
										href="./resources/docs/Helios QRG - 2016 Call To Action Guide.pdf"
										target="_blank"
							...
							<!-- <div class="" style="height:47px !important;margin-top:0px;padding-top:10px;padding-left:0px;padding-right:0px;border-bottom:1px solid #444;background-color: #1d2939;">
								<div class="caption" style="font-family: Helvetica;color: #fff;font-weight: bold;font-size: 14px;padding-left: 12px;" id="notiId">
                                 Customer LT Value :<span style="margin-left: 2px;font-size: 11px;" id="rightId"></span>
                                 </div>
                ...
                <div class="panel panel-default" style="border:none;" id="growthPlayId">
                    ...
                    <div id="growthIdBody" style="background-color: #1d2939;padding-top: 0px;" class="panel-collapse collapse" aria-expanded="true">
                        <ul class="list-group" id="growUlId" style="margin-right: 28px; margin-left: 10px; padding-top: 0px;">
                            <li class="list-group-item" ><!-- <span class="glyphicon glyphicon-pencil text-primary"></span>  --><a>Server Rebooted</a><span class="pull-right text-muted small"><em>11:32 AM</em></span></li>
                            <li class="list-group-item"><!-- <span class="glyphicon glyphicon-edit text-success"></span> --> <a>Server Not Responding</a><span class="pull-right text-muted small"><em>10:57 AM</em></span></li>
                            <li class="list-group-item"><!-- <span class="glyphicon glyphicon-share-alt text-info"></span> --> <a>New Order Placed</a><span class="pull-right text-muted small"><em>9:49 AM</em></span></li>
                            <li class="list-group-item"><!-- <span class="glyphicon glyphicon-bell text-success"></span> --> <a>Payment Received</a><span class="pull-right text-muted small"><em>Yesterday</em><span class="badge">new</span></span></li>
                        </ul>
                    </div>
                </div>
				 <div class="panel panel-default" style="border:none;" id="retPlayId">
                    ...
                    <a id="retentionId" style="text-decoration:none;" data-toggle="collapse" data-parent="#accordion" href="#retentionIdBody" class="collapsed" aria-expanded="false">
                        <h4 class="panel-title">
                            ...
                            <!--   <span id="retentionSpanId" class="glyphicon glyphicon-plus" style="color:#ddd;font-family:Helvetica;font-size: 120%;font-weight: bold !important; margin-right: 4px;"></span> -->
				...
				<div class="panel panel-default" style="border:none;" id="expPlayId">
                    ...
                    <a id="expansionId" style="text-decoration:none;" data-toggle="collapse" data-parent="#accordion" href="#expansionIdBody" class="collapsed" aria-expanded="false">
                        <h4 class="panel-title">
                            ...
                            <!--   <span id="expansionSpanId" class="glyphicon glyphicon-plus" style="color:#ddd;font-family:Helvetica;font-size: 120%;font-weight: bold !important; margin-right: 4px;"></span> -->
			...
			<!-- IAM ID Changes START -->
				...
				<!-- 					<a
										...
										style="float: right; text- decoration: none; padding-right: 10px;"><i
										class="fa fa-question-circle" aria-hidden="true"
										style="padding-left: 5px; color: #fff; font-size: 130%; vertical-align: middle;"></i>
									</a> -->
		      </div>
							<div class="portlet-body" id="notifyPanelId" style="padding: 0px;background-color: #1d2939;">
								 <div class="panel-group" id="">
                    ...
                    <a style="" id="menuItemId7">
                        <h4 class="panel-title" id="cnoId">
                              <!-- <a href="#" target="_blank" style="text-decoration: underline;color: #fff;font-family: Helvetica;font-size:14px;letter-spacing: 1px;font-weight: inherit;">Create New Opportunity</a> -->
                              <!-- <i style="color:#fff;font-size: 90%;font-weight: bold !important; margin-right: -8px;float:right;" id="gIconId" class="fa fa-chevron-down"></i> -->
                        </h4>
                        </a>
                    </div>
                ...
                <div class="panel panel-default" style="border:none;" >
                    ...
                    <a style="" id="menuItemId8">
                        <h4 class="panel-title" id="logId">
                              <!-- <a href="#" target="_blank" style="text-decoration: underline;color: #fff;font-family: Helvetica;font-size:14px;letter-spacing: 1px;font-weight: inherit;">Log A Task</a> -->
                              <!-- <i style="color:#fff;font-size: 90%;font-weight: bold !important; margin-right: -8px;float:right;" id="gIconId" class="fa fa-chevron-down"></i> -->
                        </h4>
                        </a>
                    </div>
			...
			<!-- <div class="portlet-body" id="notifyPanelId" style="padding: 0px;background-color: #1d2939;"> -->
			<div class="panel-group" id="">
				<div class="panel panel-default" style="display:block;border:none;">
                   <div id="wirDivId" class="panel-heading cnoExpand" style="display:none;" >
                   <a  href="javascript:openPerfDashboard();" style="height:35px;background-color: #1d2939;color: #fff;" data-placement="right" data-toggle="tooltip" data-container="body" title="Workplace Insights Review">
					  Workplace Insights Review
		            </a>
		            
                   <a style="display:block;" id="menuItemId7">
                       <h4 class="panel-title" id="cnoId">
                             <!-- <a href="#" target="_blank" style="text-decoration: underline;color: #fff;font-family: Helvetica;font-size:14px;letter-spacing: 1px;font-weight: inherit;">Create New Opportunity</a> -->
                             <!-- <i style="color:#fff;font-size: 90%;font-weight: bold !important; margin-right: -8px;float:right;" id="gIconId" class="fa fa-chevron-down"></i> -->
                       </h4>
