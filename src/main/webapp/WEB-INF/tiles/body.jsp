...
.modal-draggable .modal-header:hover {
  ...
  [id^='Hdr'] div ul{color:inherit !important;}
    ...
    <input class="form-control"  name="fromCdmSeeAll" id="fromCdmSeeAll" type="hidden" value="${requestScope['fromCdmSeeAll']}" />
               ...
               <div style="color:#1d2939" class="page-title">
							...
							<div class="portlet-body" id="cpContent" style="height:115px">
								<div class="col-md-6 col-sm-6 portlet-body" id="cpInfoContent" style="height:auto">
									...
									<%-- <c:if test="${ requestScope['contactStatus'] ==true }" > --%> 
										...
										<%-- <div id="contactStatusInfo" style="height:auto" class=""><span class="letterSpace" style="font-family: Helvetica;font-size: 14px;font-weight:bold;color: #333;" class="large">Contacted by: </span><span style="font-family:Helvetica !important;font-size:13px;color:#555;font-weight:bold;" id="contactedBy" class="letterSpace">${requestScope['contactName']} on ${requestScope['contactDate']}</span></div> --%>										                                 
									 <%-- </c:if> --%>
						...
						<ul class="page-breadcrumb"
							...
							<li id="crumgLiId" style="padding-left: 0px; padding-top: 3px;" ><div style="float: left; padding-right: 10px;">
								...
								<span style="display: none;" id="tempDataQual"></span>
								 <div style="float: left; padding-right: 10px;" id="qualscoreContainer">
									<span id="qualScrId"
				...
				<span class="fa fa-hand-o-up"></span>  Add new contact to SFDC
						...
						<div class="portlet box green" style="display:none;border:1px solid #004c74;background-color:#004c74;" id="shipToId">
							...
							<!-- <div class="page-bar col-lg-12 col-sm-12 col-md-12"
							style="height: 16px; font-size: 14px; color: #333; font-family: ArialMT; font-weight: 600; letter-spacing: .5px;">
							<span>This section provides details of customer order locations and shipping information</span>
							<span style="float: right;">
						     <span style="float: right;padding-left: 10px;font-weight: bold;font-size:12px;"><span style="color: #d32f2f;padding: 0px 3px;background-color: #d32f2f;font-weight: bold;box-shadow:10px 11px 11px 0 rgba(0,0,0,.1), 0 11px 15px 0 rgba(0,0,0,.1);">c</span> Globally Inactive</span>
						     <span style="float: right;padding-left: 10px;font-weight: bold;font-size:12px;"><span style="padding: 0px 3px;background-color:#ef6c00;font-weight: bold;box-shadow:10px 11px 11px 0 rgba(0,0,0,.1), 0 11px 15px 0 rgba(0,0,0,.1);color: #ef6c00;">c</span> Inactive</span>
						     <span style="float: right;padding-left: 1px;font-weight: bold;font-size:12px;"><span style="color: #00bfa5;padding: 0px 3px;background-color: #00bfa5;font-weight: bold;box-shadow:10px 11px 11px 0 rgba(0,0,0,.1), 0 11px 15px 0 rgba(0,0,0,.1);">c</span> Active</span>
						    </span>
							</div> -->
				...
				<div class="col-lg-6 sortableCol" style="padding-left:8px;">
						<!-- END PORTLET-->
					<div class="portlet box green" id="amId" style="border:1px solid #004c74;background-color:#004c74;">
							<div class="portlet-title">
								<div class="caption" style="font-family:Helvetica !important;">
									<span class="letterSpace" id="AccountMgrId">Account Manager <i style="font-size:18px !important;line-height:12px; !important" class="fa fa-angle-double-right"></i></span>  
								</div>
								<div class="tools">
						...
						<!-- chart data start -->
						<div class="portlet box green" style="border:1px solid #10acaf;background-color:#10acaf;" id="catId">
							<div class="portlet-title" style="background-color:#10acaf">
								<div class="caption" style="font-family:Helvetica !important;" id="catTitle">
									  
								</div>
								<div class="tools">
									<a class="fa fa-chevron-up" id="showHideId2" style="background-color:#10acaf;color:#fff; text-decoration: none;" href="javascript:;" data-original-title="Open Super User Data" title="">
									</a>
					...
					<!-- Ytd Data Start -->
					<div class="portlet box green" id="ytId" style="border:1px solid #004c74;background-color:#004c74;">
							<div class="portlet-title">
								<div class="caption" style="font-family:Helvetica !important;">
									<span class="letterSpace">Yearly Summary <i style="font-size:18px !important;line-height:12px; !important" class="fa fa-angle-double-right"></i></span>  
								</div>
				...
				<div id="updateDateLabelYTDSum" style="font-family: Helvetica; float:right; font-size: 10px; color: #fff; letter-spacing: .5px;padding-top:11px;"><span style="padding-right:3px;">Refreshed: </span></div>
					...
					<!-- Ytd Data End -->
						<!-- SA Feature Start  -->
						 <div class="portlet box green" id="saId" style="border:1px solid #004c74;background-color:#004c74;">
							<div class="portlet-title">
								<div class="caption" style="font-family:Helvetica !important;">
									<span class="">SA.com Features<a href="javascript:openUrl('./resources/docs/SA com Features For Helios QRG - June 2016.pdf#zoom=70,0,0&scrollbar=1');" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Click To See More Info">
				...
				<div class="row sortableRow">
					...
					<div class="col-lg-12">
						<!-- BEGIN PORTLET-->
						<div class="portlet box green" style="border:1px solid #10acaf;background-color:#10acaf;" id="mnthId">
							<div class="portlet-title" style="background-color:#10acaf">
								<div class="caption" style="font-family:Helvetica !important;" id="mnthTitle">
									  
								</div>
								<div class="tools">
									<a class="fa fa-chevron-up" id="showHideId3" style="background-color:#10acaf;color:#fff; text-decoration: none;" href="javascript:;" data-original-title="Open Super User Data" title="">
									</a>
				...
				<div class="row sortableRow">
					<div class="col-lg-12">
							<div class="portlet box green" id="mtaId" style="border:1px solid #004c74;background-color:#004c74;">
							<div class="portlet-title">
								<div class="caption" id="monthTitle">
									
								</div>
								<div class="tools">
									<a class="fa fa-chevron-up" id="showHideId5" style="background-color:#004c74;color:#fff; text-decoration: none;" href="javascript:;" data-original-title="Open Super User Data" title="">
									</a>
...
$("#showHideIdShipTo").click(function(){ 
	...
	$('#printDashboardBtn').click(function () {
		...
		logUserActivity(2007, 'Print Customer Details');
	...
	logUserActivity(2001, 'View Customer Details');
});
